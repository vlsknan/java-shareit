...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> edit(ItemDto itemDto, long userId, int itemId) {
    ...
    public ResponseEntity<Object> addComment(long userId, int itemId, CommentDto comment) {
